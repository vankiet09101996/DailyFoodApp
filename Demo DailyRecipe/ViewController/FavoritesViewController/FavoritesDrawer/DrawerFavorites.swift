...
class DrawerFavorites: UIViewController, MainSiteViewControllerDelegate     {
    
    
  var rootViewController: FavoritesViewController
  var menuController: MenuDra
  var isMenuExpanded: Bool = false
  let overlayView = UIView()
  
  init(rootViewController: HomeViewController, menuController: MenuViewController) {
